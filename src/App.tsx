...
const PRIORITY_RANK:Record<string,number>={S:0,A:1,B:2,C:3};
const byPriority=(a:Professor,b:Professor)=>(PRIORITY_RANK[a.priority]??9)-(PRIORITY_RANK[b.priority]??9)||b.score-a.score;
